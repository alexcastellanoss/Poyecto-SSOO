...
typedef struct {
  unsigned int s_inodes_count;          /* inodos de la particiÃ³n */
  unsigned int s_blocks_count;          /* bloques de la particiÃ³n */
  ...
  unsigned int s_block_size;        /* tamaÃ±o del bloque en bytes */
